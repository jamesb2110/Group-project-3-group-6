...
plt.plot(np.linspace(1,60,250),pre_bifurcation_v,color='black',linewidth=5)
plt.plot(np.linspace(22.69375,60,100),post_bifurcation_v,color='black',linewidth=5)
plt.plot(np.linspace(22.69375,60,100),unstable_v,color='black',linewidth=5,linestyle='dashed')
...
plt.savefig("Un-delayed bifurcation diagram (v values)",dpi=500)