...
c4 = 0.0
beta = 60
u_initial = [0.1,0.5,0.9,0.9,0.9]
v_initial = [0.1,0.1,0.1,0.5,0.9]
color_array = ["blue","magenta","red","lime","orange"]
...
def run_simulation(N, tau_1, tau_2, rho, epsilon, P, Q, c1, c2, c3, c4, beta, matrix_type, u_initial, v_initial):
    ...
    plt.savefig("Wilson-Cowan 5-Node Star Network Phase Portrait",dpi=500)
    ...
    plt.xticks(fontsize=25)
    plt.yticks(fontsize=25)
    plt.savefig("Wilson-Cowan 5-Node Star Network u_i(t) and v_i(t)",dpi=500)

    plt.show()

# Example usag

run_simulation(N, tau_1, tau_2, rho, epsilon, P, Q, c1, c2, c3, c4, beta, "STAR", u_initial, v_initial)
